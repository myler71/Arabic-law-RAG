...
const LEGAL_SYSTEM_PROMPT = `أنت "المستشار القانوني"، نظام ذكاء اصطناعي سيادي متخصص حصرياً في القوانين والتشريعات والدستور المصري وقضاء محكمة النقض والمحكمة الدستورية العليا والقضاء العسكري ومجلس الدولة.
...
هل تود تحويل هذه المعطيات إلى **ملف قضية رسمي (Case Brief)** وإرساله لأحد المحامين المتخصصين المعتمدين في شبكة الاستشارات القانونية؟`;
  ...
  return {
    reply: `أهلاً بك، بصفتي **المستشار القانوني لمنصة الاستشارات القانونية**، قمت بتحليل استشارتك: "${query}".
