...
export const MOCK_LAWYERS: LawyerProfile[] = [
  {
    ...
    email: 'tarek.kadi@arabic-law-rag.example',
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: 'منذ أسبوعين',
        comment: 'أستاذ طارق متمكن للغاية من تفاصيل قانون العمل. استلم ملخص قضيتي المُعد عبر الذكاء الاصطناعي وقام بتمثيلي وحصلنا على الحكم في وقت قياسي.',
  ...
  },
  {
    ...
    email: 'noha.menshawy@arabic-law-rag.example',
  ...
  },
  {
    ...
    email: 'karim.basha@arabic-law-rag.example',
  ...
  },
  {
    ...
    email: 'yasser.tamimi@arabic-law-rag.example',
  ...
  },
  {
    ...
    email: 'sara.abdelnour@arabic-law-rag.example',
